...
public class MedidaFacadeREST extends AbstractFacade<Medida> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Medida entity) {
        super.edit(entity);
    }
    ...
    public Medida find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Medida> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
